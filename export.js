...
/**
 * titleize takes a string (that's the name of a CIMPL element), 
 * and returns a string that's either the display name from displayNames (if one exists),
...
function titleize(str) {
  return displayNames[str.toLowerCase()] ? displayNames[str.toLowerCase()] : backupTitleize(str);
}
